...
$products = lf_fetch_products_by_category($conn, 'Food Delicacies', 24);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Food Delicacies | LocalFlair</title>
...
<div class="container my-5">
    ...
    <div class="d-flex align-items-end justify-content-between mb-3">
        <div>
            <h2 class="fw-bold mb-1">Food Delicacies</h2>
            <div class="text-muted">Fresh from local makers</div>
        </div>
    </div>
