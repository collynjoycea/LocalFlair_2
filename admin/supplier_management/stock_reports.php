...
<head>
    ...
    <title>Stock Reports | LocalFlair</title>
...
<body>
    ...
    <div class="main">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 30px;">
            <div>
                <h1 style="margin:0; font-weight: 800; font-size: 28px; letter-spacing: -1px;">Stock Reports</h1>
                <p style="color:var(--text-muted); margin: 5px 0 0 0; font-size: 14px;">Detailed inventory analysis and stock level monitoring.</p>
            </div>
            <a href="add_product.php" class="btn-main"><i class="fa fa-plus"></i> Add Product</a>
        </div>

        <section class="stats-grid">
            <div class="stat-card" style="border-bottom: 4px solid #cbd5e1;"><h4>Total Products</h4><span class="count"><?= number_format($countTotalProducts) ?></span></div>
                            ...
                            <tr>
                                <td>
                                    <div style="display: flex; align-items: center; gap: 15px;">
                                        ...
                                        <div>
                                            ...
                                            <div style="font-size: 11px; color: var(--text-muted);">ID: #<?= str_pad($row['product_id'], 5, '0', STR_PAD_LEFT) ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div style="display:flex; align-items:center; gap:5px; font-size: 13px;">
                                        ...
                                        <span><?= htmlspecialchars($row['province_name'] ?: 'N/A') ?></span>
                                    </div>
                                </td>
