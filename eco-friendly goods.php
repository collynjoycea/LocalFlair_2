...
$products = lf_fetch_products_by_category($conn, 'Eco-Friendly Goods', 24);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Eco-Friendly Goods | LocalFlair</title>
...
<div class="container my-5">
    ...
    <div class="d-flex align-items-end justify-content-between mb-3">
        <div>
            <h2 class="fw-bold mb-1">Eco-Friendly Goods</h2>
            <div class="text-muted">Sustainable picks for everyday use</div>
        </div>
    </div>
